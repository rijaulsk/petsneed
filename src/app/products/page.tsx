...
export const metadata: Metadata = {
  title:
    "Pet Supplies & Pharmacy in Alipore, Kolkata | Pet Food, Toys, Accessories",
  description:
...
const faqs = [
  {
    ...
    answer:
      "Currently, we operate as a walk-in store. Visit us in Alipore, Kolkata to shop our full range of products. Our convenient location makes shopping easy for pet parents across Kolkata.",
  },
  {
    question: "Can I return products?",
    answer:
      "Please check products before purchase. For any concerns about product quality or issues, speak with our team in-store and we'll do our best to help.",
  },
  {
    question: "Do you stock prescription medications?",
    answer:
      "Yes, our in-store pharmacy stocks common prescription medications. These are dispensed when our veterinarian is available or with a valid prescription from another vet.",
  },
  {
    question: "What if you don't have what I'm looking for?",
    answer:
      "We're always happy to help! If we don't currently stock an item, let us know and we'll see if we can order it for you or recommend suitable alternatives.",
  },
  {
    question: "Are your products authentic?",
    answer:
      "Absolutely. We source all products through authorized distributors and official brand channels to ensure authenticity and quality.",
  },
];
...
const whyShopReasons = [
  ...
  "Convenient Location: Easy to reach from anywhere in Kolkata",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <AnimatedSection className="space-y-6 text-center lg:text-left">
              ...
              <p className="text-lg md:text-xl text-foreground/70 max-w-xl mx-auto lg:mx-0">
                Everything your dog, cat, bird, or small pet needs—all in one
                store. Quality food, fun toys, comfy accessories, and health
                essentials from brands you trust. Visit us in Alipore, Kolkata
      ...
      <PageShell>
        ...
        <AnimatedSection as="section" className="max-w-4xl mx-auto text-center">
          <p className="text-lg text-foreground/80">
            At Pet's Need, we stock hundreds of pet care products for every
            species, breed, and life stage. Whether you're looking for
            nutritious food, entertaining toys, practical accessories, or health
            supplies, you'll find it here in our Alipore, Kolkata store. We
            carefully select items from trusted brands to ensure quality,
            safety, and value. Can't find what you need? Just ask—we're always
            happy to help you find the perfect products for your pet.
          </p>
        </AnimatedSection>
        ...
        <AnimatedSection
          id="pharmacy"
          as="section"
          className="mt-16 md:mt-24 p-8 rounded-2xl bg-accent/30 flex flex-col md:flex-row items-center gap-8"
        >
          ...
          <div className="flex-1">
            ...
            <p className="text-lg text-foreground/80 mt-2">
              For your convenience, Pet's Need has an in-store pharmacy stocking
              essential veterinary medicines, supplements, and health products.
              From flea & tick prevention to prescription diets, we provide
              authentic products to support your pet's health. Prescription
              medications are dispensed by our vets or with a valid
              prescription.
            </p>
          </div>
        </AnimatedSection>
        ...
        >
          ...
          <p className="mt-4 mb-6">
            We stock hundreds of items beyond what's listed here. Come browse
            our complete selection at 10/1D Diamond Harbour Road, Alipore,
            Kolkata. Open daily 10 AM to 10 PM!
          </p>
          <Button
            asChild
            size="lg"
